...
{
    public static class TvMatrices
    {
        //public TvMatrices()
        //{
        ...
        public readonly static Matrix4x4 Rgb2yiqMatrix = new Matrix4x4(
            new Vector4(0.299f, 0.587f, 0.114f, 0f),
            new Vector4(0.596f, -0.275f, -0.321f, 0f),
            new Vector4(0.221f, -0.523f, 0.311f, 0f),
            Vector4.zero);

        public readonly static Matrix4x4 Yiq2rgbMatrix = new Matrix4x4(
            new Vector4(1f, 0.956f, 0.621f, 0f),
            new Vector4(1f, -0.272f, -0.647f, 0f),
            new Vector4(1f, -1.106f, 1.703f, 0f),
            Vector4.zero);
    }
}