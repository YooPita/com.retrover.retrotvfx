...
namespace Retrover.RetroFx
{
    public class RetroTvEffect
    {
        ...
        public void UpdateValues()
        {
            ...
            _ntscEffectMaterial.SetMatrix("_RGB2YIQ_MAT", TvMatrices.Rgb2yiqMatrix);
            _ntscEffectMaterial.SetMatrix("_YIQ2RGB_MAT", TvMatrices.Yiq2rgbMatrix);

            _ntscEffectMaterial.SetTexture("_OverlayImg", TvOverlay);

            _ntscEffectMaterial.SetFloatArray("_LumaFilter", FilterKernelTaps8.LumaFilter);
            _ntscEffectMaterial.SetFloatArray("_ChromaFilter", FilterKernelTaps8.ChromaFilter);
